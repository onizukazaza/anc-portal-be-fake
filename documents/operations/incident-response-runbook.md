...
- [Incident Response Runbook — ANC Portal Backend](#incident-response-runbook--anc-portal-backend)
  - [สารบัญ](#สารบัญ)
  ...
  - [6. Runbook 4 — ถูกโจมตี / Security Incident](#6-runbook-4--ถูกโจมตี--security-incident)
    - [อาการ](#อาการ-3)
    - [ขั้นตอน (ทำทันที — ไม่ต้องรอ approval)](#ขั้นตอน-ทำทันที--ไม่ต้องรอ-approval)
    - [สิ่งที่ห้ามทำ](#สิ่งที่ห้ามทำ)
  ...
  - [10. Post-Incident Process](#10-post-incident-process)
    - [ขั้นตอน](#ขั้นตอน-6)
    - [หลัก Blameless Culture](#หลัก-blameless-culture)
  - [11. Contact List](#11-contact-list)
    - [ช่องทางแจ้งเหตุ](#ช่องทางแจ้งเหตุ)
